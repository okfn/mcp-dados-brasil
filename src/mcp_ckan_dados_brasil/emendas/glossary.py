...
GLOSSARY = {
    "codigo_da_emenda": {
        ...
        "definition": "Identificador da emenda parlamentar, composto por 12 dígitos: 4 do ano da emenda + 4 do código do autor + 4 do número da emenda do autor."
    },
    "ano_da_emenda": {
        "name": "Ano da Emenda",
    ...
    "codigo_do_autor_da_emenda": {
        ...
        "definition": "Código do autor da emenda parlamentar, conforme registrado no Sistema de Administração Financeira do Governo Federal - SIAFI."
    },
    "nome_do_autor_da_emenda": {
        "name": "Nome do Autor da Emenda",
        "definition": "Nome do autor da emenda parlamentar, conforme registrado no Sistema de Administração Financeira do Governo Federal - SIAFI."
    },
    "numero_da_emenda": {
        "name": "Número da Emenda",
        "definition": "Número da emenda parlamentar, conforme registrado no Sistema de Administração Financeira do Governo Federal - SIAFI."
    },
    "localidade_do_gasto": {
        "name": "Localidade do Gasto",
        "definition": "Atributo do Plano de Trabalho que indica, durante a execução da despesa, a região onde a despesa ocorre."
    },
    "codigo_municipio_ibge": {
        "name": "Código Município IBGE",
        "definition": "Código IBGE do município de destinação do recurso. Este campo poderá estar em branco, a depender da localidade de aplicação."
    },
    "municipio": {
        "name": "Município",
        "definition": "Nome do município de destinação do recurso. Este campo poderá estar em branco, a depender da localidade de aplicação."
    },
    "codigo_uf_ibge": {
        "name": "Código UF IBGE",
        "definition": "Código IBGE do estado de destinação do recurso. Este campo poderá estar em branco, a depender da localidade de aplicação."
    },
    "uf": {
        "name": "UF",
        "definition": "Nome do estado de destinação do recurso. Este campo poderá estar sem informação, a depender da localidade de aplicação."
    },
    "regiao": {
        "name": "Região",
        "definition": "Região de destinação do recurso."
    },
    "codigo_funcao": {
        "name": "Código Função",
        "definition": "Código da Função em que foi classificada a despesa associada à emenda parlamentar. Função - Representa o maior nível de agregação das diversas áreas de atuação do setor público. Reflete a competência institucional do órgão, como, por exemplo, cultura, educação, saúde, defesa, que guarda relação com os respectivos Ministérios. Fonte: Manual Técnico do Orçamento."
    },
    "nome_funcao": {
        "name": "Nome Função",
    ...
    "valor_pago": {
        "name": "Valor Pago",
        "definition": "Valor pago para a emenda."
    },
    ...
    "valor_convenio": {
        "name": "Valor Convênio",
        "definition": "É o valor correspondente à participação do concedente. É adicionado ao valor original do convênio a parcela (999) que corresponde a rendimento de aplicação financeira, quando for o caso."
    },
    "ano_mes": {
        "name": "Ano/Mês",
    ...
    "codigo_do_favorecido": {
        ...
        "definition": "Código do favorecido do pagamento realizado. Favorecidos: Entes governamentais, entidades sem fins lucrativos, demais pessoas jurídicas ou pessoas físicas que receberam transferências de recursos públicos federais, independentemente da origem desses valores. Fonte: Controladoria-Geral da União."
    },
    "favorecido": {
        "name": "Favorecido",
...
def glossary(concept: str) -> DataToolOutput:
    ...
    if d is None:
        ...
        texto = (
            f"Não existe uma definição para '{concept}' no glossário."
            f"Conceitos disponíveis: {available}."
        )
